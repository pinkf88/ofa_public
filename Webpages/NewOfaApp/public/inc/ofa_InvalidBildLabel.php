...
$sql = "UPDATE $dbt_ofa_bild_label SET valid=0 WHERE id=$bildlabelid";
// echo $sql;
...
if ($resultat_label = mysqli_query($db_link, $sql))
{
    ...
    echo '<a class="red" href="javascript:serie_validLabel(' . $bildlabelid . ')">' . $datensatz_label['label_de'] . ' / ' . $datensatz_label['label_en'] . ' (' . $datensatz_label['score'] . ')</a>';
